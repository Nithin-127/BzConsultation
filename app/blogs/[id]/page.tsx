...
"Price optimization",
      ...
      },
 {
     ...
     
  {
   ...
   {
    id: 8,
    title: "Unity 3D Game Development And How It Will Revolutionize The Metaverse",
    category: "Technology & Business",
    date: "Dec 07",
    readTime: "10 min read",
    ...
    content: [
      {
       ...
       {
        type: "h2",
        text: "How to get started with Unity Game Development?",
      },
          ...
          >
            ...
            {blog.content.map((item, index) => {
              ...
              if (item.type === "ol" && item.items) {
                return (
                  <ol key={index} className="list-decimal pl-5 mt-4 space-y-3">
                    {item.items.map((li, i) => (
                      <li key={i}>{li}</li>
                    ))}
                  </ol>
            ...
            <h1 className="text-[32px] md:text-[36px] text-white font-black mt-7 ml-2">
              Related Articles
            </h1>
          </div>
